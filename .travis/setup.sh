...
sudo sed -i 's/^\(lxd:[0-9]\{1,\}\):.*/\1:100000000/' /etc/subuid
sudo sed -i 's/^\(root:[0-9]\{1,\}\):.*/\1:100000000/' /etc/subuid
sudo sed -i 's/^\(lxd:[0-9]\{1,\}\):.*/\1:100000000/' /etc/subgid
sudo sed -i 's/^\(root:[0-9]\{1,\}\):.*/\1:100000000/' /etc/subgid
